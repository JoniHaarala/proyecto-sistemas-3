...
export let passRegex = new RegExp('^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[^a-zA-Z0-9])(?!.*\s).{8,15}$');

// eslint-disable-next-line no-invalid-regexp
export let ccRegex = '^(4|5)[0-9]+{16}';